...
- Coding and bugfix workflows launch from `/home/devuser/claudeclaw` with `--branch`; Archon then runs nodes in a managed isolated worktree under `~/.archon/workspaces/devuser/claudeclaw/worktrees/...`, not directly in production.
