...
OBS-03 is satisfied when Archie and Hopper can inspect active Archon worktrees/runs and clean up stale isolated work safely under Archon-managed `~/.archon/workspaces/devuser/claudeclaw/worktrees/...` paths or the legacy/manual `/home/devuser/claudeclaw-worktrees` root.
...
The production checkout is `/home/devuser/claudeclaw`. Cleanup must refuse that path and operate only under Archon-managed `~/.archon/workspaces/devuser/claudeclaw/worktrees/...` paths or the legacy/manual `/home/devuser/claudeclaw-worktrees` root.
