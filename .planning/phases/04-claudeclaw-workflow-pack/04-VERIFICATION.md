...
|---|---|---|---|---|
| Workflow YAML files | Workflow definitions | Repo-owned `archon/workflows/claudeclaw-*.yaml` | Yes | VERIFIED -- all six parse with expected names, requirement IDs, and steps. |
...
| Workflow YAML definitions parse | `node` + `js-yaml` over `archon/workflows/claudeclaw-*.yaml` | All six parsed with expected names, FLOW IDs, and 4-5 steps. | PASS |
